...
abstract class BasePage extends StatefulWidget {
  ...
  void navigateToNextSection(BuildContext context);
}
...
class _BasePageState extends State<BasePage>
    ...
    if (newPageIndex != widget.pageIndex) {
      setState(() {
        ...
        if (widget.menu != null &&
          ...
          widget.navigateToNextSection(context);
        }
      });
    }
  }
  ...
  int getCurrentSectionColor() {
    return widget.menu != null
        ? widget.menu!.section![widget.sectionIndex].colors
        : widget.section.section[widget.sectionIndex].colors;
  }
        ...
        title: Text(
          widget.menu != null
              ? widget.menu!.section![widget.sectionIndex]
                  .page![widget.pageIndex].titre
              : widget.section.section[widget.sectionIndex]
                  .page![widget.pageIndex].titre,
          style: TextStyle(fontSize: 12),
  ...
  @override
  void navigateToNextSection(BuildContext context) {
    // Implémentation spécifique pour chaque sous-classe si nécessaire
  }
}
class HomePage extends BasePage {
  HomePage({
    Key? key,
    required Welcome section,
  ...
  void navigateToNextSection(BuildContext context) {
    ...
    if (nextSectionIndex < section.section.length) {
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => HomePage(
            ...
            pageIndex: 0,
            page: section.section[nextSectionIndex].page![0],
          ),
        ),
      );
    }
...
class Menus extends BasePage {
  ...
  void navigateToNextSection(BuildContext context) {
    final nextSectionIndex = sectionIndex + 1;
    if (nextSectionIndex < menu!.section!.length) {
      final nextSection = menu?.section![nextSectionIndex];
