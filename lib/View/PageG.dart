    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Row(
            children: [
              widget.section.section[widget.sectionIndex].menu == null
                  ? Text('Page de la Sections ', style: TextStyle(fontSize: 16))
                  : Text('Sections du Menu', style: TextStyle(fontSize: 16)),
                  Expanded(
                 child: IconButton(
                  onPressed: () {
